...
{{--        @endif--}}
        <div class="col-lg-6 col-xl-12">
            <div class="card">
                ...
                <div class="card-block text-center">
                    <div id="tw_chart" class="chart-shadow"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-xl-6">
            <div class="card">
                ...
                <div class="card-block text-center">
                    <div id="oral_chart" class="chart-shadow"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-xl-6">
            <div class="card">
                <div class="card-header">
                    <h3>{{ __('Oral & Practical')}}</h3>
                </div>
                <div class="card-block text-center">
                    <div id="prac_chart" class="chart-shadow"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h3>{{ __('End Semester Exam')}}</h3>
                </div>
                <div class="card-block text-center">
                    <div id="ese_chart" class="chart-shadow"></div>
                </div>
            </div>
        </div>
            ...
            <script>
                ...
                config.ia_data = [
                        ...
                        @if ($result->ia_flag)
                    {
                        ...
                        "ut1": {{ $result->ut1 == null ? 0 : $result->ut1 }},
                        "ut2": {{ $result->ut2 == null ? 0 : $result->ut2 }},
                        "ia": {{ $result->ia == null ? 0 : $result->ia }}
                    },
                        @endif
                    @endforeach
                ];
                config.tw_data = [
                        @foreach($results as $result)
                        @if ($result->course->tw != null)
                    {
                        "course": '{{ $result->course_name }}',
                        "tw": {{ $result->tw == null ? 0 : $result->tw }},
                        {{--"ut2": {{ $result->ut2 == null ? 0 : $result->ut2 }},--}}
                        {{--"ia": {{ $result->ia == null ? 0 : $result->ia }}--}}
                    },
                    @endif
                ...
                config.oral_data = [
                        @foreach($results as $result)
                        @if ($result->course->oral != null)
                    {
                        "course": '{{ $result->course_name }}',
                        "oral": {{ $result->oral == null ? 0 : $result->oral }},
                    },
                    @endif
                    @endforeach
                ];
                config.prac_data = [
                        @foreach($results as $result)
                        @if ($result->course->oral_practical != null)
                    {
                        "course": '{{ $result->course_name }}',
                        "prac": {{ $result->oral_practical == null ? 0 : $result->oral_practical }},
                    },
                    @endif
                    @endforeach
                ];
                config.ese_data = [
                        @foreach($results as $result)
                        @if ($result->course->ese != null)
                    {
                        "course": '{{ $result->course_name }}',
                        "prac": {{ $result->ese == null ? 0 : $result->ese }},
                    },
                    @endif
                    @endforeach
                ];
